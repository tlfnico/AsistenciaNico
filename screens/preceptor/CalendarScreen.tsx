                        ...
                        <h3 className="text-xl font-semibold capitalize text-brand-secondary border-b pb-2 mb-3">{monthYear}</h3>
                         <div className="space-y-3">
                            {eventsGroupedByMonth[monthYear].map(event => {
                                ...
                                return (
                                <div key={event.id} onClick={() => onEventClick(event)} className={`group flex justify-between items-center gap-4 p-3 rounded-lg border-l-4 transition-all duration-200 cursor-pointer hover:scale-[1.02] hover:shadow-lg ${styles.bg} ${styles.mainBorder}`}>
                                    ...
                                    <div className={`flex-shrink-0 p-2 rounded-full bg-white/50 group-hover:bg-white/80 ${styles.text}`}>
