...
const PreceptorLayout: React.FC<{ children: ReactNode }> = ({ children }) => {
            ...
            <aside className="hidden md:flex md:flex-col md:w-72 bg-brand-primary text-white p-4 justify-between">
                 <div>
                    <div className="mb-10 text-center">
                        ...
                        <h2 className="text-2xl">Preceptor</h2>
                    ...
                    <nav className="flex flex-col gap-3">
                        {navItems.map((item) => (
                            ...
                            >
                                ...
                                <span className="text-lg">{item.label === 'Asistencia' ? 'Tomar Asistencia' : item.label}</span>
                            </NavLink>
                        ))}
                    </nav>
                </div>
